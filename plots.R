...
t = 20        # number of generations. Also initial state for t.
...
WF.det.list = simulate.trajecs.hs(pops,N,m,msub,r,t,seldmi,selanc,domdmi,source.freqs)
WF.sto.list = WF.trajec.reps.hs(pops,N,m,msub,r,t,seldmi,selanc,domdmi,source.freqs,reps)
